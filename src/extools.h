...
struct date_time {
    unsigned char month,day,year,hour,min;
};
...
int linedt(char *,int,int,int,int,int *,int *,struct cmndline_params *);
int enter_screen(struct scr_params[],int,int *,enum en_mode_type);
